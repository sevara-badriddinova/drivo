            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600">Thousand of verified vehicles from trusted dealerships and private sellers.</p>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-600">Verified listings and secure booking process for the best experience.</p>
                    </div>
                </div>
