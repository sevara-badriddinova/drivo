...
const CarCard = ({car}) => {
  ...
  // placeholder for heart icon clicked
  const handleToggleSave = async (e) => {
    e.preventDefault();
    setIsSaved((prev) => !prev);
  };
  return (
  <Card className="block w-full overflow-hidden hover:shadow-lg transition group py-0">
    ...
    {/* colors heart red if saved, gray for not saved */}
